...
export const SERVICES_DATA = [
    ...
    },
    {
        ...
        desc: "Creative tối ưu Hook để giữ chân người xem, tăng watch-time và dễ dàng scale số lượng lớn khi test.",
        colorHover: "hover:border-orange/50",
        glow: "from-orange/20 to-transparent",
    }
];
