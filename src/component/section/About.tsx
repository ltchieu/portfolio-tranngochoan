...
export default function About() {
  return (
    <section
      id="about"
      className="py-24 px-5 md:px-9 border-b border-border bg-[rgba(240,237,232,0.02)]"
    >
      <div className="max-w-[1160px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-[72px] items-start">
        ...
        <Reveal delay={0}>
          ...
          <h2 className="text-[clamp(28px,3.5vw,46px)] font-bold tracking-[-0.04em] leading-[1.1] text-cream mb-0">
            Em bắt đầu với danh ads thủ, sau đó bén duyên làm marketing.
            <br />
        ...
        <Reveal delay={100}>
          <div className="text-[15.5px] leading-[1.85] text-[rgba(240,237,232,0.55)] mb-10 [&>p]:mb-4 [&_strong]:text-cream [&_strong]:font-semibold">
            <p>
              Trước khi tập trung hoàn toàn vào AI creatives, em từng làm khá
              nhiều công việc liên quan tới ads, video AI, social media và vận
              hành marketing cho agency.
            </p>
            <p>
              Điều đó giúp em nhận ra rằng:{" "}
              <strong>
                phần khó nhất chưa bao giờ chỉ là tạo ra một video AI đẹp.
              </strong>{" "}
              Mà là tạo ra một video đủ tự nhiên để người xem muốn dừng lại, đủ
              linh hoạt để test liên tục và đủ hiệu quả để phục vụ cho marketing
              thật.
            </p>
            <p>
              Hiện tại em đang phát triển AI production theo 2 hướng song song:{" "}
              <strong>cinematic storytelling cho brand</strong> và{" "}
              <strong>
                performance-focused AI UGC cho social media & ads.
              </strong>
            </p>
          </div>
        </Reveal>
      ...
      <div className="mt-12 w-full px-0 md:px-0 flex justify-center">
        <div className="w-full max-w-[1160px] flex flex-col gap-3">
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
            <div className="flex-1 bg-card border border-blue/30 rounded-[14px] p-5 transition-all duration-300 hover:border-blue hover:shadow-[0_4px_20px_rgba(91,156,246,0.1)] relative group">
              ...
              <div className="text-[13px] text-muted leading-[1.5]">
                Vận hành marketing, social media và triển khai ads cho nhiều
                nhãn hàng &amp; local business.
              </div>
            </div>
            ...
            <div className="flex-1 bg-card border border-purple/30 rounded-[14px] p-5 transition-all duration-300 hover:border-purple hover:shadow-[0_4px_20px_rgba(184,156,246,0.1)] relative group">
              ...
              <div className="text-[13px] text-muted leading-[1.5]">
                Tự nghiên cứu realistic AI UGC, affiliate TikTok, AI video
                workflow và performance creatives.
              </div>
            </div>

            <div className="flex justify-center text-purple/50 text-sm md:text-base">
              <FaArrowRight className="hidden md:block" />
              <FaArrowDown className="block md:hidden" />
            </div>
            ...
            <div className="flex-1 bg-card border border-green/30 rounded-[14px] p-5 transition-all duration-300 hover:border-green hover:shadow-[0_4px_20px_rgba(205,255,90,0.1)] relative group">
              ...
              <div className="text-[13px] text-muted leading-[1.5]">
                AI Supervisor. Phát triển AI workflow, TVC và visual production
                cho các campaign truyền thông.
              </div>
            </div>
          </div>
          ...
          <div className="mt-1 w-full bg-[#111] border border-orange/40 rounded-[14px] p-5 transition-all duration-300 hover:border-orange hover:shadow-[0_4px_25px_rgba(255,106,53,0.15)] group relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="text-[13.5px] text-muted leading-[1.6]">
                Xuất phát từ ads, social media và marketing. Trải nghiệm thực tế
                với content, livestream, TikTok.
              </div>
            </div>
          </div>
        </div>
